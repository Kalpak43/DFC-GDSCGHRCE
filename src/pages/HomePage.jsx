  ...
  return (
    <div   className="w-screen lg:h-screen px-4 lg:px-10 py-8 grid grid-cols-1 lg:grid-cols-6 lg:grid-rows-6 gap-4">
      <div   className="lg:col-start-1 lg:col-end-3 w-full h-full rounded-2xl flex gap-4 order-1 lg:order-auto">
        <motion.div drag className="w-fit lg:h-full aspect-square bg-blue-500 rounded-2xl">
          Dark Mode
        </motion.div>
        <motion.div drag className="lg:h-full w-full border-2 border-black rounded-2xl">
      ...
      <motion.div drag className="lg:col-start-5 lg:col-end-7 lg:row-start-1 lg:row-end-3 border-2 border-black w-full h-full rounded-2xl order-7 lg:order-auto">
