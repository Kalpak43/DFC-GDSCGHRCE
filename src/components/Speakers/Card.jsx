...
function Card(props) {
  ...
  return (
    <div className="card flex flex-wrap  w-full  ">
      <div className="card__border rounded-full p-1 mt-5 mr-10 hover:scale-105">
        <img
      ...
      <div
        className={`card__social ${showSocial ? "animation" : ""}`}
        id="card-social"
      >
        <div className="card__social-control">
          <div
            className="card__social-toggle"
            onMouseEnter={toggleSocial}
            id="card-toggle"
          >
            <span className="ri--add-line"></span>
          </div>

          <span className="card__social-text text-sm font-semibold ">
            Social Networks
          </span>
