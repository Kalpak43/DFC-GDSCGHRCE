...
function Card({ name, role, image, linkedin }) {
  return (
    <div className="w-full h-full py-2">
      <div className="relative md:h-[80%] w-full border-2 border-[var(--google-blue)] rounded-xl mb-4 flex flex-col md:flex-row justify-center gap-4 items-center p-4 pb-8 bg-black bg-opacity-40">
        ...
        <div className="text-center md:text-left mb-2 md:mb-0 text-white">
