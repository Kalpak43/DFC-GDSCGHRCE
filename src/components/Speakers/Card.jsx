...
function Card({ name, role, image, linkedin, title }) {
  return (
      <div className="relative h-[90%] md:h-[80%] w-full border-2 border-[var(--google-blue)] rounded-xl mb-4 flex flex-col md:flex-row gap-4 items-center p-4 md:px-10 pb-8 bg-black bg-opacity-40" title={title}>
