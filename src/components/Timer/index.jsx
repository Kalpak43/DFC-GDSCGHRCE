...
export default function Timer() {
  ...
  return (
    <div className="hero w-full h-full flex flex-col items-center justify-center">
      ...
      <p
        className="select-none text-4xl font-bold bg-gradient-to-r from-[var(--google-red)] via-[var(--google-blue)] via-[var(--google-yellow)] to-[var(--google-green)] inline-block text-transparent bg-clip-text"
      >
        {days !== undefined ? `${days}:` : ""}
